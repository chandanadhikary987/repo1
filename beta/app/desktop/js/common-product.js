$(document).ready(function() {
        if ($(window).scroll(function() {
                ...
                i >= 200 ? $("body").addClass("stickHeader") : $("body").removeClass("stickHeader"), i >= 150 ? $("body").addClass("noticed") : $("body").removeClass("noticed")
            ...
            $("#writereview").show();
            var i = $("html, body"),
                e = $("#reviews").offset().top - 500;
            i.stop().animate({
                scrollTop: e
            }, 500)
        } else $("#writereview").hide()
    }),
    function(i) {
        "use strict";
...
dotNums.forEach(removeText), $(document).ready(function() {
    $(".gotoLink").on("click", function(i) {
        if ("" !== this.hash) {
            i.preventDefault();
            var e = this.hash;
            $("html, body").animate({
